...
namespace sakurajin{
    namespace unit_system{
        ...
        class UNIT_SYSTEM_EXPORT_MACRO unit_t{
        public:
        ...
        template <size_t identifier>
        UNIT_SYSTEM_EXPORT_MACRO unit_t<identifier> unit_cast(const unit_t<identifier>& unit, long double new_multiplier = 1, long double new_offset = 0){
        ...
        template <size_t identifier>
        UNIT_SYSTEM_EXPORT_MACRO unit_t<identifier> clamp(const unit_t<identifier>& unit, const unit_t<identifier>& lower, const unit_t<identifier>& upper){
        ...
        UNIT_SYSTEM_EXPORT_MACRO long double multiplier(std::ratio<numerator, denumerator>){
            long double num = static_cast<long double>(numerator);
            long double den = static_cast<long double>(denumerator);
            return num/den;
        }
...
namespace std{
    template<size_t identifier>
    sakurajin::unit_system::unit_t<identifier> abs(const sakurajin::unit_system::unit_t<identifier>& unit){
        auto inv = -unit;
