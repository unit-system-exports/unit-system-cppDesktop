...
sakurajin::unit_system::mass::mass(long double v, long double mult): mass{v,mult,0}{}
sakurajin::unit_system::mass::mass(long double v, long double mult, long double off): multiplier{mult}, value{v}, offset{off}{}
...
sakurajin::unit_system::mass sakurajin::unit_system::unit_cast(const sakurajin::unit_system::mass& unit, long double new_multiplier, long double new_offset){
    return unit.convert_copy(new_multiplier, new_offset);
}

sakurajin::unit_system::mass sakurajin::unit_system::clamp(const sakurajin::unit_system::mass& unit, const sakurajin::unit_system::mass& lower, const sakurajin::unit_system::mass& upper){
