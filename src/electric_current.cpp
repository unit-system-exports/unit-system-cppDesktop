...
sakurajin::unit_system::electric_current::electric_current(long double v, long double mult): electric_current{v,mult,0}{}
sakurajin::unit_system::electric_current::electric_current(long double v, long double mult, long double off): multiplier{mult}, value{v}, offset{off}{}
...
sakurajin::unit_system::electric_current sakurajin::unit_system::electric_current::operator+(const sakurajin::unit_system::electric_current& other) const{
...
sakurajin::unit_system::electric_current sakurajin::unit_system::electric_current::convert_copy(long double new_multiplier, long double new_offset) const{
...
sakurajin::unit_system::electric_current sakurajin::unit_system::unit_cast(const sakurajin::unit_system::electric_current& unit, long double new_multiplier, long double new_offset){
    return unit.convert_copy(new_multiplier, new_offset);
}

sakurajin::unit_system::electric_current sakurajin::unit_system::clamp(const sakurajin::unit_system::electric_current& unit, const sakurajin::unit_system::electric_current& lower, const sakurajin::unit_system::electric_current& upper){
