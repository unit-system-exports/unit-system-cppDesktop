...
common::energy common::operator*(const common::force& F, const base::length& s){
    auto F1 = sakurajin::unit_system::unit_cast(F,F.multiplier);
    auto s1 = sakurajin::unit_system::unit_cast(s,s.multiplier);
...
common::force common::operator/(const common::energy& E, const base::length& s){
    auto E1 = sakurajin::unit_system::unit_cast(E,E.multiplier);
    auto s1 = sakurajin::unit_system::unit_cast(s,s.multiplier);
...
common::energy common::operator*(const common::momentum& p, const common::speed& v){
    auto p1 = sakurajin::unit_system::unit_cast(p,p.multiplier);
    auto v1 = sakurajin::unit_system::unit_cast(v,v.multiplier);
